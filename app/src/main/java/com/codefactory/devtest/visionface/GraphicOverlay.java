...
public class GraphicOverlay extends View{
    ...
    private final static String TAG = GraphicOverlay.class.getSimpleName();
...
//			Log.i("TRANSLATE_Y", "Y: "+y+ "mY: "+frog);
    ...
    public void setCameraInfo(int previewWidth, int previewHeight, int facing){
        synchronized(mLock){
            ...
            this.mFacing=facing;
            Log.i(TAG, "setCameraInfo Preview H: "+previewHeight+" W: "+previewWidth);
        }
        postInvalidate();
    }
...
//				Log.i(TAG, "onDraw CANVAS size H: "+heightScaleFactor+" W: "+widthScaleFactor);
            }
