...
public class FaceVisionUtils {
    ...
    private final static float eulerYMax=15f, eulerZMax=15f, smileChange=0.3f;
    ...
    public static String bioTemp="temporary bio....";
    ...
    public static double[] extracSensiBio(HashMap<Integer, PointF> land){
        ...
        for (int i = 0; i < face.size(); i++) {
            ...
            for (int j = i + 1; j < face.size(); j++) {
                ...
                bioMsg = bioMsg.concat("point["+i+","+j+"]: "+dist+"\n");
                if (i == 0 && j == 1) {
                    unit = dist;
                } else {
